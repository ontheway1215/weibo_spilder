...
example_weibo_id = "durexinchina"##3278620272想爬取的微博号的ID
...
headers = {
		...
		'Host':'weibo.com',
		'Pragma':'no-cache',
		'Referer':'http://weibo.com/u/durexinchina?profile_ftype=1&is_all=1',
...
# html = get_object_weibo_by_weibo_id_and_cookie(example_weibo_id,cookie)
